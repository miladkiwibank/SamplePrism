...
namespace SamplePrism.Presentation.Controls.Interaction
{
    ...
    public partial class KeyboardWindow : Window
    {
        ...
        {
            InitializeComponent();
            Top = Settings.Default.KeyboardTop;
            Left = Settings.Default.KeyboardLeft;
            Height = Settings.Default.KeyboardHeight;
            Width = Settings.Default.KeyboardWidth;
        ...
        {
            Settings.Default.KeyboardHeight = Height;
            Settings.Default.KeyboardWidth = Width;
            Settings.Default.KeyboardTop = Top;
            Settings.Default.KeyboardLeft = Left;
        }
