...
namespace SamplePrism.Presentation.Controls.UIControls
{
    public class DiagramCanvas : InkCanvas
    {
        ...
        public DiagramCanvas()
        {
            ...
            var menuItem = new MenuItem { Header = SamplePrism.Localization.Properties.Resources.Properties };
            menuItem.Click += MenuItemClick;
            ButtonContextMenu.Items.Add(menuItem);
            var mi2 = new MenuItem { Header = SamplePrism.Localization.Properties.Resources.Settings };
            mi2.Click += Mi2Click;
            ButtonContextMenu.Items.Add(mi2);
            var mi3 = new MenuItem { Header = SamplePrism.Localization.Properties.Resources.Delete };
            mi3.Click += Mi3Click;
