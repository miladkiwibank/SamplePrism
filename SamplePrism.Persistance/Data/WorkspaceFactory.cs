...
using SamplePrism.Infrastructure.Data.SQL;
using SamplePrism.Infrastructure.Data.Text;
using SamplePrism.Infrastructure.Settings;

namespace SamplePrism.Persistance.Data
{
    ...
    public class Initializer : IDatabaseInitializer<DataContext>
    {
        ...
        private static void Migrate(CommonDbContext context)
        {
            ...
            //        Database = db,
            //        Target = LocalSettings.AppPath + "\\SamplePrism.Persistance.DbMigration.dll"
            //    };
